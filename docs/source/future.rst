...
- **Networks**: a plot of nodes and of the edges joining them, with a rule placing the nodes on the canvas (`Issue 160 <https://github.com/piccolomo/plotext/issues/160>`_).
