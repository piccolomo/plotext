...
clink.add('point', 'delete').input().output(void)
clink.add('point', 'get', 'wstring').input(void).output(cstring)
clink.add('point', 'get', 'col').input(void).output(size)
clink.add('point', 'get', 'row').input(void).output(size)
...
clink.add('points', 'add').input(void, void).output(void)
clink.add('points', 'set', 'fill', 'point').input(void, size, void).output(void)
clink.add('points', 'log', 'x').input(void).output(void)
clink.add('points', 'log', 'y').input(void).output(void)
clink.add('points', 'rescale', 'x').input(void, float, float, size, float).output(float)
clink.add('points', 'rescale', 'y').input(void, float, float, size, float).output(float)
clink.add('points', 'fill').input(void).output(void)
clink.add('points', 'get', 'wstring').input(void).output(cstring)
clink.add('points', 'get', 'length').input(void).output(size)
clink.add('points', 'get').input(void, size).output(void)
clink.add('points', 'get', 'xmin').input(void).output(float)
clink.add('points', 'get', 'xmax').input(void).output(float)
clink.add('points', 'get', 'ymin').input(void).output(float)
clink.add('points', 'get', 'ymax').input(void).output(float)
clink.add('points', 'copy').input(void).output(void)
clink.add('points', 'assign').input(void, void).output(void)
clink.add('points', 'add_offset').input(void, float, float).output(void)
clink.add('points', 'get', 'wstring').input(void).output(cstring)
...
clink.add('dots', 'add').input(void, void).output(void)
