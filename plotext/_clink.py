...
clink.add('point', 'get', 'wstring').input(void, bool).output(cstring) 
...
clink.add('signal', 'set', 'details').input(void, bool, bool, wstring).output(void) 
clink.add('signal', 'add', 'point').input(void, void).output(void) 
#clink.add('signal', 'set', 'fill', 'point').input(void, size, void).output(void)
...
clink.add('signal', 'get', 'wstring').input(void).output(cstring) 
...
clink.add('signal', 'get', 'side').input(void, bool).output(bool) 
...
#clink.add('signal', 'fill').input(void, void).output(void) 
