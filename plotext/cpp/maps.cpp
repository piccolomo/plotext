...
enum MarkerType {normal, hd, fhd, braille};

const unordered_map<MarkerType, string> marker_labels = {
  {normal,  "normal"},
  {hd,      "hd"},
  {fhd,     "fhd"},
  {braille, "braille"}};

const unordered_map<MarkerType, unsigned char> marker_rows = {
  {normal,  1},
  {hd,      2},
  {fhd,     3},
  {braille, 4}};

 const unordered_map<MarkerType, unsigned char> marker_cols = {
  {normal,      1},
  {hd,      2},
  {fhd,     2},
  {braille, 2}};
