// Colorize class: Manages a string with an associated Pixel (color + style)
...
public:
    ...
    Colorize & operator=(Colorize && o) noexcept {
        destroy(); string = o.string; o.destroy(); copy_pixel(o); 
        return *this;}
    ...
    // Display the Colorize object
    inline void print(bool colorless = false) const noexcept { wcout << get_wstring(colorless) << flush; }
