...
source("plotext.matrix()")
out("html string for the matrix", explanation("string"))
...
doc("Saves the matrix to a file. The file extension determines the format: .html saves as HTML, .ansi saves as text with ANSI color codes, anything else saves as plain uncolored text.")
source("plotext.matrix()")
