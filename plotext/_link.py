...
link.add('matrix', 'insert_colorize').input(void, size, size, void, integer, bool).output(bool)
link.add('matrix', 'insert_colorize_dynamically').input(void, size, size, void).output(bool)
