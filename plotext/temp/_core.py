...
# def candlestick(dates, data, positive_color = None, negative_color = None, orientation = None, xside = None, yside = None, label = None):
#     _figure._active.candlestick(dates, data, xside = xside, yside = yside, orientation = orientation, positive_color = positive_color, negative_color = negative_color, label = label)
#     _figure.show() if _figure._interactive else None

# def box(*args, quintuples = None, color = None, fill = None, width = None, orientation = None, minimum = None, reset_ticks = None, xside = None, yside = None, label = None):
#     _figure._active.box(*args, xside = xside, yside = yside, orientation = orientation, color = color, label = label, fill=fill, width = width, minimum = minimum, reset_ticks = reset_ticks, quintuples = quintuples)
#     _figure.show() if _figure._interactive else None
