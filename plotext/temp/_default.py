...
class default_signal_class():
    fill = False
    fill_internal = "internal"
    lines = False
...
class default_yaxis_class(default_xaxis_class):
    frequency = 7


default_figure = default_figure_class()
default_monitor = default_monitor_class()
default_signal = default_signal_class()
default_canvas = default_canvas_class()

default_xaxis = default_xaxis_class()
default_yaxis = default_xaxis_class()
