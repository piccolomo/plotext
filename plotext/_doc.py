...
par("args", "the grouped data to plot or its specific boundaries. need a type and a default value???")
par("hint", "??? need a description a type and a default value??")
par("colors", "??? need a description a type and a default value??")
past("fill", "bar")
past("width", "bar")
past("orientation", "bar")
past("minimum", "bar")
