...
par("hint", "If hint=true, the input data is an array of quintuples, each representing the precomputed maximum, q75, q50, q25 and minimum values, otherwise it's the original data. The default value for hint is false.", t.bool, False)
