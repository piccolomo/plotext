...
def check_color(color = None):
    return color if is_color(color) else default_color
...
default_color_sequence = ["blue+", "green+", "red+", "cyan+", "magenta+", "yellow", "gray", "blue", "green", "red", "cyan", "magenta", "gold", "black"] # standard color sequence for multiple data plots
default_color_sequence += [el for el in colors if el not in default_color_sequence] 
