...
def xruler(frequency = None, scale = None, alignment = None, direction = None, pixel = None, side = 0):
    _master._active.xruler(frequency = frequency, alignment = alignment, direction = direction, scale = scale, pixel = pixel)
    return _master._active

def yruler(frequency = None, scale = None, alignment = None, direction = None, pixel = None, side = 0):
    _master._active.yruler(frequency = frequency, alignment = alignment, direction = direction, scale = scale, pixel = pixel)
    return _master._active
