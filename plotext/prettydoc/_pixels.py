...
default_pixels = {
	...
	"parameter.type": pixel(foreground = 'default', style = 'default'),
	"parameter.default.label": pixel(foreground = 'orange+', style = 'dim'),
	"parameter.default": pixel(foreground = 'default', style = 'default'),
	"parameter.doc": pixel(foreground = 'default', style = 'italic'),
	"output.name": pixel(foreground = 'default', style = 'bold'),
	"output.type.label": pixel(foreground = 'orange+', style = 'dim'),
	"output.type": pixel(foreground = 'default', style = 'default'),
